...
public class AlunoController {
    ...
    public Response cadastraNomeAluno(@Valid @RequestBody Aluno entity) {
        ...
        return new Response(201, "Aluno Registrado"); //Um novo registro foi criado
    ...
    public Response deleteAluno(@PathVariable Long id) {
        if (!repository.existsById(id)) {
            return new Response(404, "Aluno Não Encontrado"); // O recurso com o ID informado não existe ou a URL
